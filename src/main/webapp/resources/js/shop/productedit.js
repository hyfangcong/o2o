$(function() {
    ...
    var infoUrl = '/o2o/shop/getproductbyid?productId=' + productId + '&shopId=' + 2;
    var categoryUrl = '/o2o/shop/getproductcategorylist?shopId='
        + shopId;
    ...
    $('#submit').click(
        function() {
            ...
            formData.append('smallImg', thumbnail);
            $('.detail-img').map(
                function(index, item) {
